...
namespace jimo::timing
{
    ...
    /// \brief Exception class for all StopWatch error conditions
    ///
    ...
    class StopWatchException : public std::runtime_error
    {
        public:
           ...
           ///@{
            ...
            StopWatchException(const std::string& what_arg)
                : std::runtime_error(what_arg) {}
            /// \param what_arg Array of characters that contain the error message.
            StopWatchException(const char* what_arg)
                : std::runtime_error(what_arg) {}
            ///@}
    };
}